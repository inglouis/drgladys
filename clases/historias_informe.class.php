        ...
        public function informe_consultar($args) {
            ...
            $sql = "
                select
                    ...
                    t.hora,
                    t.fecha_nacimiento,
                    coalesce(NULLIF(t.agudeza_od_1, ''), '0.00')::numeric(7,2) AS agudeza_od_1,
                    coalesce(NULLIF(t.agudeza_od_4, ''), '0.00')::numeric(7,2) AS agudeza_od_4,
                    coalesce(NULLIF(t.agudeza_od_lectura, ''), '0.00')::numeric(7,2) AS agudeza_od_lectura,
                    coalesce(NULLIF(t.agudeza_oi_1, ''), '0.00')::numeric(7,2) AS agudeza_oi_1,
                    coalesce(NULLIF(t.agudeza_oi_4, ''), '0.00')::numeric(7,2) AS agudeza_oi_4,
                    coalesce(NULLIF(t.agudeza_oi_lectura, ''), '0.00')::numeric(7,2) AS agudeza_oi_lectura,
                    t.biomicroscopia,
                    t.contenido,
                    t.control,
                    t.correccion_1,
