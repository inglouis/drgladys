    ...
    <div class="filas" style="height: fit-content; position:relative;">
      ...
      <div class="columnas" >
        ...
        <div>
          ...
          <section data-grupo="cc-referencias-referencia-editar" class="combo-consulta">
            <input type="text" autocomplete="off"  data-limit="">
      ...
      <div class="columnas">
        ...
        <div>
          ...
          <textarea rows="4" id="refeditar-informacion" data-previa="refeditar-previa" data-valor="referencia" class="refeditar-valores upper lleno textarea-espaciado contenedor-personalizable" style="resize:none; min-height: 15vh;" data-scroll></textarea>
        </div>
          ...
          <div class="filas" style="height: 100%; position: relative">
            ...
            <div class="columnas" >
              ...
              <div>
                ...
                <section data-grupo="cc-referencias-referencia-insertar" class="combo-consulta">
                  <input type="text" autocomplete="off"  data-limit="">
                  <select class="referencia-valores upper visual" data-valor="id_referencia" data-scroll style="color:#262626"></select>
                </section>
            ...
            <div class="columnas">
              ...
              <div>
                ...
                <textarea rows="4" id="referencia-informacion" data-previa="referencia-previa" data-valor="referencia" class="referencia-valores upper textarea-espaciado contenedor-personalizable" style="resize:none; min-height: 15vh;" data-scroll></textarea>
              </div>
