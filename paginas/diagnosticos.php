<?php 
  ...
  //---------------------------------------
  include_once('../clases/diagnosticos.class.php');
...
<html lang="es">
  ...
  <head>
      ...
      <script type="module" src="../js/diagnosticos.js" defer></script>
...
<!------------------------- CUERPO ----------------------- -->
  ...
  <body data-scroll>
        ...
        <div class="filas" style="height: fit-content;">
          <div class="columnas">
            <div>
              ...
              <input type="text" data-valor="nombre" class="informacion-valores visual upper" disabled="true">
            </div>
          </div>
          ...
          <div class="columnas">
            <div>
              <label class="requerido">Estado del Diagnóstico</label>
              <select class="informacion-valores visual lleno" data-valor="status" disabled="true">
    ...
    <div id="crud-editar-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-editar-pop" class="popup-oculto" data-scroll style="justify-content: flex-start; width: 40%">
        ...
        <div class="filas" style="justify-content: flex-start;">
          ...
          <div class="columnas">
            ...
            <div>
              <label>Nombre</label>
              <input type="text" data-valor="nombre" placeholder="Nombre del diagnóstico" class="editar-valores lleno iupper">
            </div>
        ...
        <div class="filas">
          ...
          <div class="columnas" style="align-items: baseline;">
            ...
            <div>
              ...
              <input type="text" placeholder="Nombre del diagnóstico" class="insertar-valores lleno upper">
            </div>
          </div>
        </div>
          ...
          <section>
            ...
            <div class="datos">
              ...
              ">
                ...
                <button id="diagnosticos-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="diagnosticos-filtros" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro diagnosticos-status">
            ...
            <div id="tabla-principal" class="tabla-ppal table-min">
              <table id="tabla-diagnosticos" class="table table-bordered table-striped">
                <thead>
                </thead>
                <tbody>
                </tbody>
