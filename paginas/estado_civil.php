<?php 
  ...
  //---------------------------------------
  include_once('../clases/estado_civil.class.php');
    ...
    <div id="crud-informacion-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-informacion-pop" class="popup-oculto" data-scroll style="justify-content: flex-start;">
        ...
        <div class="filas" style="height: fit-content;">
          ...
          <div class="columnas">
            <div>
              <label class="requerido">Status del Estado Civil</label>
      ...
      <div id="crud-editar-pop" class="popup-oculto" data-scroll style="justify-content: flex-start; min-width: 400px; width: 40%">
        ...
        <div class="filas" style="justify-content: flex-start;">
          ...
          <div class="columnas">
            ...
            <div>
              <label>Descripción</label>
                <input type="text" data-valor="nombre" placeholder="Descripcion del Estado Civil" class="editar-valores lleno iupper">
            </div>
          </div>
        ...
        <div class="filas">
          ...
          <div class="columnas" style="align-items: baseline;">
            ...
            <div>
              ...
              <input type="text" placeholder="Descripción del Estado Civil" class="nuevos lleno upper">
            </div>
          </div>
        </div>
          ...
          <section>
            ...
            <div class="datos">
              ...
              ">
                ...
                <button id="estado_civil-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="estado_civil-filtros" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro estado_civil-status">
            ...
            <div id="tabla-principal" class="tabla-ppal table-min">
              <table id="tabla-estado_civil" class="table table-bordered table-striped">
                <thead>
                </thead>
                <tbody>
                </tbody>
