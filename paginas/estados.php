<?php 
  ...
  //---------------------------------------
  include_once('../clases/estados.class.php');
...
<html lang="es">
  ...
  <head>
      ...
      <title>ESTADOSs</title>
      <script type="module" src="../js/estados.js" defer></script>
    ...
    <div id="crud-informacion-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-informacion-pop" class="popup-oculto" data-scroll style="justify-content: flex-start;">
        ...
        <div class="filas" style="height: fit-content;">
          ...
          <div class="columnas">
            <div>
              <label class="requerido">Status del estado</label>
      ...
      <div id="crud-editar-pop" class="popup-oculto" data-scroll style="justify-content: flex-start; min-width: 400px; width: 40%">
        ...
        <div class="filas" style="justify-content: flex-start;">
          ...
          <div class="columnas">
            ...
            <div>
              <label>Nombre</label>
                <input type="text" data-valor="nombre" placeholder="Descripcion del Estado" class="editar-valores lleno iupper">
            </div>
          </div>
        ...
        <div class="filas">
          ...
          <div class="columnas" style="align-items: baseline;">
            ...
            <div>
              ...
              <input type="text" placeholder="Descripción del Estado" class="nuevos lleno upper">
            </div>
          </div>
        </div>
          ...
          <section>
            ...
            <div class="datos">
              ...
              ">
                ...
                <button id="estados-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="estados-filtros" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro estados-status">
