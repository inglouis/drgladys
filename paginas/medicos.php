<?php 
  ...
  //---------------------------------------
  include_once('../clases/medicos.class.php');
...
<html lang="es">
  ...
  <head>
      ...
      <title>medicos</title>
      <script type="module" src="../js/medicos.js" defer></script>
      ...
      <div id="crud-informacion-pop" class="popup-oculto" data-scroll style="justify-content: flex-start;">
        ...
        <div class="filas" style="height: fit-content;">
          <div class="columnas">
            <div>
              <label>Nombre</label>
              <input type="text" data-valor="nombres_apellidos" class="informacion-valores upper visual" disabled="true">
            </div>
          </div>
          ...
          <div class="columnas">
            <div>
              ...
              <input type="text" data-valor="direccion" class="informacion-valores upper visual" disabled="true">
            </div>
          </div>
          ...
          <div class="columnas">
            <div>
              <label class="requerido">Estado del Médico</label>
      ...
      <div id="crud-editar-pop" class="popup-oculto" data-scroll style="justify-content: flex-start; min-width: 400px; width: 40%">
        ...
        <div class="filas" style="justify-content: flex-start;">
          ...
          <div class="columnas">
            ...
            <div>
              <label>Nombre</label>
                <input type="text" data-valor="nombres_apellidos" placeholder="Nombre swl Médico" class="editar-valores lleno iupper">
            </div>
          </div>
          ...
          <div class="columnas">
            ...
            <div>
              <label>Dirección</label>
                <input type="text" data-valor="direccion" placeholder="Dirección swl Médico" class="editar-valores lleno iupper">
            </div>
          </div>
      ...
      <div id="crud-insertar-pop" class="popup-oculto" style="width: 50%">
        ...
        <div class="filas">
          ...
          <div class="columnas" style="align-items: baseline;">
            ...
            <div>
              <label class="requerido">nombres_apellidos</label>  
              <input type="text" placeholder="Nombre del Médico" class="nuevos lleno upper">
            </div>

            <div>
              <label>dirección</label>  
              <input type="text" placeholder="Direccón del Médico" class="nuevos lleno upper">
            </div>
          ...
          <section>
            ...
            <div class="datos">
              ...
              ">
                ...
                <button id="medicos-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="medicos-filtros" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro medicos-status">
            ...
            <div id="tabla-principal" class="tabla-ppal table-min">
              <table id="tabla-medicos" class="table table-bordered table-striped">
                <thead>
                </thead>
                <tbody>
                </tbody>
