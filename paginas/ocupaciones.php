<?php 
  ...
  //---------------------------------------
  include_once('../clases/ocupaciones.class.php');
...
<html lang="es">
  ...
  <head>
      ...
      <script type="module" src="../js/ocupaciones.js" defer></script>
          ...
          <section>
            ...
            <div class="datos">
              ...
              ">
                ...
                <button id="ocupaciones-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="ocupaciones-filtros" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro ocupaciones-status">
            ...
            <div id="tabla-principal" class="tabla-ppal table-min">
              <table id="tabla-ocupaciones" class="table table-bordered table-striped">
                <thead>
                </thead>
                <tbody>
                </tbody>
