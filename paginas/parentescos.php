<?php 
  ...
  //---------------------------------------
  include_once('../clases/parentescos.class.php');
...
<html lang="es">
  ...
  <head>
      ...
      <script type="module" src="../js/parentescos.js" defer></script>
    ...
    <div id="crud-informacion-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-informacion-pop" class="popup-oculto" data-scroll style="justify-content: flex-start;">
        ...
        <div class="filas" style="height: fit-content;">
          ...
          <div class="columnas">
            <div>
              <label class="requerido">Estado del Parentesco</label>
      ...
      <div id="crud-editar-pop" class="popup-oculto" data-scroll style="justify-content: flex-start; min-width: 400px; width: 40%">
        ...
        <div class="filas" style="justify-content: flex-start;">
          ...
          <div class="columnas">
            ...
            <div>
              <label>Descripción</label>
                <input type="text" data-valor="nombre" placeholder="Descripciòn del Parentesco" class="editar-valores lleno iupper">
            </div>
          </div>
        ...
        <div class="filas">
          ...
          <div class="columnas" style="align-items: baseline;">
            ...
            <div>
              ...
              <input type="text" placeholder="Descripción del Parentesco" class="nuevos lleno upper">
            </div>
          </div>
        </div>
          ...
          <section>
            ...
            <div class="datos">
              ...
              ">
                ...
                <button id="parentescos-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="parentescos-filtros" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro parentescos-status">
