...
<html lang="es">
  <head>
      ...
      <title>ACTUALIZACIÓN PRESENTACIONES MÉDICAS</title>
      ...
      <style type="text/css">
        ...
        #tabla-presentaciones-editar tbody tr td:nth-child(1), #tabla-presentaciones-insertar tbody tr td:nth-child(1) {
            width:5%;
        }

        #tabla-presentaciones-editar tbody tr td:nth-child(2), #tabla-presentaciones-insertar tbody tr td:nth-child(1) {
            width:90%;
        }

        #tabla-presentaciones-editar tbody tr td:nth-child(3), #tabla-presentaciones-insertar tbody tr td:nth-child(1) {
            width:10%;
            min-width: 30px;
        }

        [data-estilo="tabla-presentaciones"] {
            min-height: 300px;
  ...
  <body data-resaltar class="scroll-form">
    ...
    <div id="crud-eliminar-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-eliminar-pop" class="popup-oculto">
        ...
        <section id="crud-eliminar-titulo" data-crud='titulo'>
            ¿Confirma eliminar presentaciones Médicos ?
        </section>
        <p style="color:red">Esto eliminará permanentemente el presentacion Médico de la Base de Datos, si quieres deshabilitar el presentacion Médico lo puedes hacer desde la Opción de Editar</p>
      ...
      <div id="crud-insertar-pop" class="popup-oculto" style="width:70%; min-width:600px ;height: fit-content;">
        ...
        <section class="filas">
          ...
          <div style="width:100%; padding-top: 10px;">
            <div>
            <label>Presentaciones del medicamento</label>
    ...
    <div id="crud-editar-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-editar-pop" class="popup-oculto" style="width: 70%; min-width: 600px;">
        ...
        <section id="crud-editar-titulo" data-crud='titulo'>
            Editar datos del presentacion Médico
        </section> 
        ...
        <section class="filas">
          ...
          <div style="width:100%; padding-top: 10px;">
            <label>Presentaciones del medicamento</label>
            <div style="display: flex;">
              <input type="text" id="presentaciones-busqueda-editar" data-estilo="busqueda" placeholder="Busqueda">
    ...
    <div class="container-fluid bg-3 paginas-contenedor">
      <div id="titulo-contenedor">  
        <h3>LISTADO DE PRESENTACIONES MÉDICAS</h3>
      </div>
      <div id="contenido-contenedor">        
        <div class="panel-body">
          <section>
            <div class="datos">
              <button id="insertar-presentaciones" style='margin-top:-30px' class="btn btn-primary pull-right btn-nuevo tooltip-filtro-reverso">
                +
              </button>
              ...
              <div id="presentaciones-filtros" class="filtros">
