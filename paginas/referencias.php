<?php 
  ...
  //---------------------------------------
  include_once('../clases/referencias.class.php');

  //---------------------------------------
  //OBJETO DE CLASE (referencia)
  //---------------------------------------
  $obj = new Model();
...
<html lang="es">
  ...
  <head>
      ...
      <script type="module" src="../js/referencias.js" defer></script>
      <script type="module" src="../js/main.js" defer></script>
      <style type="text/css">
        #tabla-referencias tbody tr td:nth-child(1) {
            width: 3%
        }

        #tabla-referencias tbody tr td:nth-child(2) {
            width: 20%
        }

        #tabla-referencias tbody tr td:nth-child(3) {

        }

        #tabla-referencias tbody tr td:nth-child(4) {
            width: 10%
        }

        #tabla-referencias tbody tr td:nth-child(5) {
            min-width: 50px;
            width: 5%;
        }
      </style>
    ...
    <div id="crud-eliminar-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-eliminar-pop" class="popup-oculto">
        ...
        <section id="crud-eliminar-titulo" data-crud='titulo'>
            ¿Confirmar eliminación de la referencia?
        </section>
        <p style="color:red">Esto eliminará permanentemente la referencia del sistema</p>
        ...
        <section class="filas">
          ...
          <div class="columnas" style="width:100%;">
            ...
            <div>
              ...
              <input type="text" data-valor="nombre" size="100" minlength="1" maxlength="100" class="insertar-valores lleno upper">
            </div>
          ...
          <div class="columnas">
            ...
            <div>
              <label class="requerido">Descripción de la referencia</label>
              <textarea data-valor="descripcion" minlength="1" maxlength="600" class="insertar-valores lleno upper" style="resize: none" rows="4"></textarea> 
            </div>
      ...
      <div id="crud-editar-pop" class="popup-oculto" style="width: 50%; min-width: 600px;">
        ...
        <section class="filas">
          ...
          <div class="columnas">
            ...
            <div>
              <label class="requerido">Nombre de la referencia</label>  
          ...
          <div class="columnas">
            ...
            <div>
              <label class="requerido">Descripción de la referencia</label>
              <textarea data-valor="descripcion" minlength="1" maxlength="600" class="editar-valores lleno upper" style="resize: none" rows="4"></textarea> 
            </div>
          ...
          <section>
            ...
            <div class="datos">
              ...
              <div style="display: flex;justify-content: center;align-items: center;padding: 0px 5px;">
                ...
                <button id="referencias-insertar" class="btn btn-nuevo tooltip-filtro">+</button>

              </div>

              <div id="referencias-status" class="filtros" style="padding-left: 10px;">

                <div data-grupo="status" class="grupo">

                  <section class="filtro referencias-status">
