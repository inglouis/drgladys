    ...
    <div id="crud-eliminar-popup" class="popup-oculto" data-crud='popup'>
      <div id="crud-eliminar-pop" class="popup-oculto">
        ...
        <section id="crud-eliminar-titulo" data-crud='titulo'>
            ¿Confirma eliminacion de tratamientos Médico?
        </section>
        <p style="color:red">Esto eliminará permanentemente el Tratamiento Médico</p>
        ...
        <section class="filas">
          ...
          <div class="columnas">
            ...
            <div>
              ...
              <label>Tratamientos del medicamento</label>
          	...
          	<div>
	            ...
	            <div style="
	            	display: flex;
    				    ...
    				    align-items: center;
	            ">
	              <input type="text" id="tratamientos-busqueda-editar" data-estilo="busqueda" placeholder="Busqueda" class="upper">
          ...
          <section>
            ...
            <div class="datos">
              ...
              <div style="display: flex;justify-content: center;align-items: center;padding: 0px 5px;">
                ...
                <button id="tratamientos-insertar" class="btn btn-nuevo tooltip-filtro">+</button>
              ...
              <div id="tratamientos-status" class="filtros" style="padding-left: 10px;">
