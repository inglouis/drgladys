...
<page style="width: 200mm" backtop="1mm" backbottom="5mm" backleft="5mm" backright="5mm">
  <div class="contenedor">
    ...
    <table style="margin-bottom: 5mm; border:none">
      <tbody>
        <tr>
          <td style="width: 170mm; text-align: center;"><div style="width:fit-content; border-bottom: 2px dashed #ccc; font-size: 16px">CONSTANCIA DE ACOMPAÑANTE</div></td>
        </tr>
      </tbody>
    </table>  
    ...
    <table style="border:none">
      <tbody>
        <tr>
          <td style="width: 170mm; text-align: left">ASISTIÓ A CONSULTA EN (DD/MM/AAAA): <div class="unbold"><?php echo $datos[3]?> acompañado de:</div></td>
        </tr> 
      </tbody>    
    </table>
    ...
    <table style="border:none">
      <tbody>
        <tr>
          <td style="width: 170mm; text-align: left">CÉDULA ACOMPAÑANTE: </div></td>
        </tr> 
      </tbody>    
    </table>
