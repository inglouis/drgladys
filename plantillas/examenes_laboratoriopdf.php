<?php
  ...
  */
  ...
  if (isset($_REQUEST['datos'])) {
    $examen_lab = json_decode($_REQUEST['datos'], true);
  } else {
...
<?php
  ...
  if($pdf !== 0) {
    ...
    {  
        ...
        if($pdf == 1) {
          $html2pdf->Output("../reportes/examenes_laboratorio/examenes_laboratorio$nombre.pdf", "f");
        } else if ($pdf == 2) {
          $html2pdf->Output("../reportes/examenes_laboratorio/examenes_laboratorio$nombre.pdf");
        } else if ($pdf == 3){      
          $html2pdf->Output("../reportes/examenes_laboratorio/examenes_laboratorio$nombre.pdf");
          $html2pdf->output("../reportes/examenes_laboratorio/examenes_laboratorio$nombre.pdf", "f");
        }
