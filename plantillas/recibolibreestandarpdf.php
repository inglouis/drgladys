...
<page style="width:200mm" backtop="40mm" backbottom="5mm" backleft="10mm" backright="2mm">
  <div class="contenedor">
    ...
    <table>
      <tbody>
        <tr>
          ...
          <td style="font-size: 16px; width: 77mm; padding:0px; position:relative; text-align: right;">FACTURA N°: <?php echo $correlativo?></td>
        </tr>
      </tbody>
    </table>  
    ...
    <table>
      <tbody>
        <tr>
          <td style="font-size: 12px">Razón social: <?php echo strtoupper($persona)?></td>
    ...
    <table style="width: 200mm; margin-top: 0px; border-left: none; border-collapse: collapse; position: relative; top: -6px">
      <thead>
        <tr>
          ...
          <th style="width: 55mm; font-size: 10px" class="conceptos-cabecera">DESCRIPCIÓN DEL SERVICIO PRESTADO</th>
    ...
    <div>
      ...
      <div style='font-size:14px; width:178mm; text-align:right; font-weight: bold; position: relative; top: -10px'>Monto total a pagar BsS: 
        <?php 
